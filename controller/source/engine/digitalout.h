...
class DigitalOut :public BaseShell
{
 ...
 private:
  ...
  typedef void(DigitalOut::*pIntFunc)( int);
  ...
  // access functions
	...
	typedef bool (DigitalOut::*pGetFunc)(char* ret, unsigned ret_size) const;
	typedef bool (DigitalOut::*pSetFunc)(const char* new_value);
